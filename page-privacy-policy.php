    ...
    <div class="pp-doc__main">
      ...
      <section class="pp-section" id="use-and-share">
        ...
        <ul class="pp-list pp-list--titled">
          <li><strong>Connecting You With Agents</strong> Information you provide may be made available to eligible Agents when needed to review or respond to your insurance request. Ensurance does not broadly distribute your request for unrelated marketing purposes.</li>
          <li><strong>Additional Request Access</strong> If an initial eligible Agent is unable to assist, Ensurance may make the request available to another eligible Agent so you can continue toward an appropriate next step.</li>
