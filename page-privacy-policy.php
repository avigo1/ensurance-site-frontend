    ...
    <div class="pp-doc__main">
      ...
      <section class="pp-section" id="use-and-share">
        ...
        <ul class="pp-list pp-list--titled">
          ...
          <li><strong>Additional Request Review</strong> If the first agent we connect you with does not respond, or if we determine your needs may be better served by additional options, we may share your information with other qualified agents so you still receive assistance.</li>
