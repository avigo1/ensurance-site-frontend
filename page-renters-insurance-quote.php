<?php
/**
 * Template Name: Renters Insurance Quote (Marketing)
 *
 * /renters-insurance-quote — renters intake page. An exact reuse of the
 ...
 * "Renters Insurance Quote Request" form, placed in the page's editor
 ...
 * by construction. Enqueued via ensurance_renters_insurance_quote_assets()
 * in functions.php, scoped to this template only.
 *
 * FORM SLOT: the editor content of this WordPress page should contain ONLY the
 * Ninja Forms embed — the shortcode [ninja_form id='8'] (Renters Insurance
 ...
 * <title> override.
 *
 * This page was cloned from the auto template, and the Yoast SEO title came
 * along with it — it still reads "SECURE Auto Insurance Quotes Online | …", so
 * the renters page ships the wrong title. Force the correct one here.
 *
...
$sq_next = array(
    ...
    array( 'user',     'Your request is organized',  'Ensurance organizes your details so your renters insurance request is clearer before review.' ),
...
get_header( 'home' );
?>
<main id="main" class="page-auto-quote page-renters-quote">
  ...
  <section class="sq-request reveal" aria-label="Start your request">
    ...
    <div class="sq-request__inner">
      ...
      <div class="sq-request__intro">
        ...
        <h1 class="sq-request__title">Start your renters insurance request with more clarity.</h1>
      ...
      <!-- ── FORM SLOT ────────────────────────────────────────────────
           Renders ONLY the Renters Insurance Quote Request Ninja Form:
           the [ninja_form] shortcode is extracted from this page's
           editor content (falling back to form 8), so the page's
           retired Gutenberg layout can never leak into the card. -->
      <div class="sq-formslot">
        <?php
        while ( have_posts() ) :
            the_post();
            ensurance_sq_render_form( 8 );
        endwhile;
        ?>
      </div>
