...
// "Start health request" funnels into the guided intake wizard with health
// preselected (mirrors the standalone design's /start?coverage=health).
$hq_start_url    = esc_url( home_url( '/start' ) . '?coverage=health' );
