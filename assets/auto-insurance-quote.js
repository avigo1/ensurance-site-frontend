/* ===================================================================
   "Auto Insurance Quote" (/auto-insurance-quote) — scroll-reveal.
   ...
   home.js handles the rest of the chrome (mobile nav, sticky CTA); this
   file only owns the reveal motion. Respects prefers-reduced-motion by
   showing everything immediately, and a safety timeout reveals anything
   still hidden so content can never get stuck behind the initial
   opacity:0.
   =================================================================== */
(function () {
  function init() {
