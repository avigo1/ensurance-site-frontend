/* ===================================================================
   "For Agents" — scroll-reveal transitions.

   Ported from the standalone design's App useEffect: every reveal
   target (sections marked .reveal, plus each stepper row .fa-step)
   fades/slides in once its top crosses 90% of the viewport.
...
(function () {
  function init() {
    var targets = [].slice
      ...
      .concat([].slice.call(document.querySelectorAll(".fa-step")));
