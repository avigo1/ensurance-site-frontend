...
$sq_next = array(
    ...
    array( 'user',     'Your request is organized',  'Ensurance organizes your details so your health insurance request is clearer before review.' ),
  ...
  <section class="sq-request reveal" aria-label="Start your request">
    ...
    <div class="sq-request__inner">
      ...
      <div class="sq-request__intro">
        ...
        <h1 class="sq-request__title">Start your health insurance request with more clarity.</h1>
      ...
      <!-- ── FORM SLOT ────────────────────────────────────────────────
           Renders ONLY the Health Insurance Quote Request Ninja Form:
           the [ninja_form] shortcode is extracted from this page's
           editor content (falling back to form 7), so the page's
           retired Gutenberg layout can never leak into the card. -->
      <div class="sq-formslot">
        <?php
        while ( have_posts() ) :
            the_post();
            ensurance_sq_render_form( 7 );
        endwhile;
        ?>
      </div>
